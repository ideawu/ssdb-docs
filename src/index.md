...
SSDB is a fast NoSQL database for storing big list of billions of elements, it supports data structures including KV, map, zset(sorted set), it is an alternative for Redis, or works with Redis.
